...
class Scoreboard:
    """Клас, що виводить рахунок та іншу інформацію на екрані."""
    ...
    def __init__(self, ai_game):
        ...
        # Налаштування шрифту для відображення рахунку та рівня.
        self.text_color = (30, 30, 30)
        self.font = pygame.font.SysFont(None, 48)

        # Підготувати зображення з початковим рахунком та рівнем.
        self.prep_score()
    ...
    def show_score(self):
        """Показати на екрані рахунок, рівень та кораблі"""
    ...
    def prep_high_score(self):
        ...
        # Відцентрувати рекорд по центру верхнього краю екрана.
